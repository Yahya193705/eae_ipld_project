...
# ----- Profile image file -----
profile_image_file_path = "yahya_pict.png"       # TODO: Upload your profile image to the same folder as this script and update this if it has a different name
...
- 📫 How to reach me: 
         yahyaakd2@gmail.com 
         AND 
         https://www.linkedin.com/in/yahya-akdi-9717861a1
